...
class GetAllAnakResponseModel {
    final String? message;
    final int? statusCode;
    final List<Datum>? data;

    GetAllAnakResponseModel({
        this.message,
        this.statusCode,
        this.data,
    });

    factory GetAllAnakResponseModel.fromJson(String str) => GetAllAnakResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory GetAllAnakResponseModel.fromMap(Map<String, dynamic> json) => GetAllAnakResponseModel(
